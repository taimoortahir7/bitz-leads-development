...
const Feature = ({ feature }) => {
  ...
  const renderContent = () => {
    ...
    if (float === "left") {
      doc = (
        <div className="h-screen lg:h-auto mx-0 lg:mx-4 py-4 lg:py-2 lg:my-16 px-8 xl:px-16 flex flex-col sm:flex-row items-start lg:items-center justify-between ">
          <div className="w-full sm:w-1/2 lg:w-6/12 h-full flex flex-col items-start justify-center ">
            <Title content={title} />
            <Para text={text} />
          </div>
      ...
      doc = (
        <div className="h-screen lg:h-auto mx-0 lg:mx-4 py-4 lg:py-2 lg:my-16 px-8 xl:px-16 flex flex-col-reverse sm:flex-row items-start lg:items-center justify-between ">
          ...
          <div className="w-full sm:w-1/2 lg:w-6/12 h-full flex flex-col  justify-center items-start pl-0 lg:pl-24 xl:pl-40  xl:items-start">
            <Title content={title} />
            <Para text={text} />
          </div>
        </div>
